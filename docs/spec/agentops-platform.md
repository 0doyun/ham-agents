...
| tool blocking / real-time intercept | Phase 2 Embedded PTY + Approval Interception 에서 차단 가능 (ham-studio.md P2-3 참조) | ✓ Phase 2 Embedded PTY + Approval Interception 에서 차단 가능 (ham-studio.md P2-3 참조) |
