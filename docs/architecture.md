...
- Quick-message UI now routes through a dedicated sender boundary, with the current app-edge implementation explicitly behaving as a clipboard + session-opening handoff baseline.
